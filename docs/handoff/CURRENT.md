...
## 最新ステータス（2026-07-31 更新）
- ブランドコンセプト・デザイン制作イメージ・ガイドライン・店舗情報・SNS方針を統合した**唯一無二のコンセプト正本 `docs/foundation/concept.md`** が完成・確定。
- 重複していた README や分割ドキュメントを整理し、ルートの `README.md` に正本・開発情報を一元管理。

## 現在のフェーズ
- **デザイン刷新プレビュー実装準備フェーズ**
- ブランドコンセプト正本 `docs/foundation/concept.md`（カラーパレット `#F8F5F0`, `#2F4964`, `#C95B4F` 等）に基づきデザインプレビューを実装・確認する段階。
